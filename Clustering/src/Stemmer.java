...
public class Stemmer {
    ...
    //proses stem
    //proses stem
    private  String Stem(String kata){
        if(DictGenerator.getIndexAlphabet().contains(getFirstChart(kata))){
            //System.out.println(kata);
            if (!stringMatcher(kata, DictGenerator.getKamusKDid().get(getFirstChart(kata)))){
...
//        System.out.println(kata + " mampir ke Hps_derivation_suffixes");
        ...
        if (kata.endsWith("i")||kata.endsWith("an")||kata.endsWith("kan")){
            ...
            if (stringMatcher(Hasil, DictGenerator.getKamusKDid().get(getFirstChart(Hasil)))){
//                System.out.println("Hasil: "+Hasil);
                return Hasil;
            }
            if (kata.endsWith("k")){
                Hasil2 = kata.replaceAll("(k)$", "");
                if (stringMatcher(Hasil2, DictGenerator.getKamusKDid().get(getFirstChart(Hasil2)))){
//                    System.out.println("Hasil2: "+Hasil2);
                    return Hasil2;
                }
            }
...
//        System.out.println("der_suffixes: "+der_suffixes);
    ...
    private String Hps_derivation_prefixes(String kata){
        ...
        if (kata.startsWith("di")||kata.startsWith("ke")||kata.startsWith("se")){
            ...
            if (stringMatcher(Hasil, DictGenerator.getKamusKDid().get(getFirstChart(Hasil))))return Hasil;
            Hasil2 = Hps_derivation_suffixes(Hasil);
            if (stringMatcher(Hasil2, DictGenerator.getKamusKDid().get(getFirstChart(Hasil2)))) return Hasil2;
